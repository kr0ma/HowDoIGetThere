...
<div class = "form-group">
	...
	<div class="col-sm-3">
		<form:input path="username" autofocus='autofocus' required='required' cssClass="form-control" />		
	</div>		
...
<div class = "form-group">
	...
	<div class="col-sm-3">
		<form:password path="password" autofocus='autofocus' required='required' cssClass="form-control"/>		
	</div>
	<div class="col-sm-3 has-error">
...
<div class = "form-group">
	...
	<div class="col-sm-3">
		<form:input path="surname" autofocus='autofocus' required='required' cssClass="form-control"/>		
	</div>
	<div class="col-sm-3 has-error">
